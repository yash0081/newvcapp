 ...
 * Heuristic only — keeps "funding" sessions from auto-saving random founder/product lines.
 *
 * Keep in sync with extension/shared/steering-focus.ts (extension cannot import this module).
 */
...
/**
 * Returns true if the suggestion should be kept for this steering note.
 */
